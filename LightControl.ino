...
#define TIME_TO_SLEEP_MINS 1 //10
...
{
    printf("send_UDP\n");
    Serial.println(&g_timeInfo, "UDP local time: %A, %B %d %Y %H:%M:%S");
...
void loop() 
{
    ...
    int lux = myLightSensor.getLux();
    if(lux < 100)
    {
        printf("Night time, Lights ON\n");
